$(document).ready(function() {
  const apiRoot = 'https://shielded-meadow-33029.herokuapp.com/v1/task/';
  const trelloApiRoot = 'https://shielded-meadow-33029.herokuapp.com/v1/trello/';
  ...
  function handleTaskDeleteRequest() {
     var parentEl = $(this).parents('[data-task-id]');
     var taskId = parentEl.attr('data-task-id');
     var requestUrl = apiRoot + 'removeTask';
